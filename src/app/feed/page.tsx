    ...
    <>
      ...
      <div style={{ fontFamily: 'inherit', color: '#1a202c', minHeight: '100vh', paddingBottom: '48px' }}>
        ...
        <main style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px', marginTop: '32px' }}>
          ...
          {/* 
          ORIGINAL HOME TAB CONTENT - COMMENTED OUT
          {activeTab === 'home' && (
          ...
          */}
          ...
          {/* 
          ORIGINAL EXPLORE TAB CONTENT - COMMENTED OUT
          {activeTab === 'explore' && (
          ...
          */}
          ...
          {/* 
          ORIGINAL MESSAGES TAB CONTENT - COMMENTED OUT
          {activeTab === 'messages' && (
            <div style={{
              display: 'grid',
          ...
          */}
          ...
          {/* 
          ORIGINAL NOTIFICATIONS TAB CONTENT - COMMENTED OUT
          {activeTab === 'notifications' && (
            <div style={{
              maxWidth: '800px',
              margin: '0 auto',
          ...
          */}
          ...
          {/* 
          ORIGINAL COMMUNITIES TAB CONTENT - COMMENTED OUT
          {activeTab === 'communities' && (
